...
namespace SpectrumNet
{
    ...
    public sealed class SphereRenderer : BaseSpectrumRenderer
    {
        ...
        private static class Constants
        {
            ...
            public const float PI_OVER_180 = (float)(Math.PI / 180);
        ...
        private void UpdateConfiguration((float Radius, float Spacing, int Count) config)
        {
            SmartLogger.Safe(() =>
            {
                ...
                _sphereRadius = Math.Max(Constants.MIN_RADIUS, _sphereRadius);
        ...
        private void AdjustConfiguration(int barCount, float barSpacing, int canvasWidth, int canvasHeight)
        {
            SmartLogger.Safe(() =>
            {
                _sphereRadius = Math.Max(5f, Constants.DEFAULT_RADIUS - barCount * 0.2f + barSpacing * 0.5f);
                _sphereSpacing = Math.Max(2f, Constants.DEFAULT_SPACING - barCount * 0.1f + barSpacing * 0.3f);
        ...
        private bool ValidateRenderParameters(SKCanvas? canvas, float[]? spectrum, SKImageInfo info, SKPaint? paint)
        {
            ...
            {
                SmartLogger.Log(LogLevel.Warning, Constants.LOG_PREFIX, "Insufficient spectrum data");
                return false;
            }
