...
namespace SpectrumNet.Views.Renderers
{
    ...
    public sealed class BarsRenderer : BaseSpectrumRenderer
    {
        ...
        private BarsRenderer()
        {
            ...
            _highlightPaint = CreateBasicPaint(SKColors.White, Fill);
        ...
        protected override void ApplyQualitySettings()
        {
            Safe(() =>
            {
                ...
                _glowPaint.MaskFilter = _useGlowEffect ?
                    SKMaskFilter.CreateBlur(Normal, _glowRadius) : null;

                Log(LogLevel.Debug, Constants.LOG_PREFIX, $"Quality set to {_quality}");
            }, new ErrorHandlingOptions
            {
