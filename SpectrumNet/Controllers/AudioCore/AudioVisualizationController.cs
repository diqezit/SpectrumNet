...
public class AudioVisualizationController : INotifyPropertyChanged, IDisposable, IAudioVisualizationController
{
    ...
    private DispatcherTimer _saveSettingsTimer = new() { Interval = FromMilliseconds(500) };
    ...
    private static Settings AppSettings => Settings.Instance;
    ...
    private async Task CleanupResourcesAsync()
    {
        ...
        try
        {
            ...
            DisposeResourceSafely(() => RendererFactory.DisposeAllRenderers(), "Renderer factory");
