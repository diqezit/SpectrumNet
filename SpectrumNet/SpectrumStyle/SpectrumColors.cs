...
namespace SpectrumNet
{
    public static class ColorUtilities
    {
        ...
        public static SKColor MixColors(SKColor c1, SKColor c2, float amount) =>
            new SKColor(
                (byte)((1 - amount) * c1.Red + amount * c2.Red),
                (byte)((1 - amount) * c1.Green + amount * c2.Green),
                (byte)((1 - amount) * c1.Blue + amount * c2.Blue),
                (byte)((1 - amount) * c1.Alpha + amount * c2.Alpha)
            );
    ...
    public sealed class GradientStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            ColorConstants.Primary, ColorConstants.PrimaryDark,
    ...
    public sealed class SolidStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            new SKColor(0xFF, 0x63, 0x47), new SKColor(0xFF, 0x63, 0x47),
    ...
    public sealed class RadialStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            new SKColor(0x8A, 0x2B, 0xE2), new SKColor(0xFF, 0x14, 0x93),
    ...
    public sealed class NeonStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            new SKColor(0x00, 0xFF, 0x00), new SKColor(0x66, 0xFF, 0x66),
            (start, end) => CreateLinearGradient(start, ColorUtilities.MixColors(end, ColorConstants.Primary, 0.5f), new SKPoint(0, 0), new SKPoint(0, 1))
        );
    }
    ...
    public sealed class RadiantGlassStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            new SKColor(0xE0, 0xF7, 0xFA), new SKColor(0xB3, 0xE5, 0xFC),
            (start, end) =>
            {
                var paint = BasePaint();
    ...
    public sealed class MetallicStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            new SKColor(0xC0, 0xC0, 0xC0), new SKColor(0xA0, 0xA0, 0xA0),
            (start, end) =>
            {
    ...
    public sealed class MinimalistPatternStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.DarkSlateGray, SKColors.LightSteelBlue,
            (primary, secondary) =>
            {
                const int size = 20;
    ...
    public sealed class ShinyStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.DeepSkyBlue, SKColors.Blue, CreateSpecularHighlightPaint);
    ...
    public sealed class DarkGradientStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            new SKColor(0x33, 0x33, 0x33), new SKColor(0x66, 0x66, 0x66),
            (start, end) => CreateLinearGradient(start, end, new SKPoint(0, 0), new SKPoint(0, 1))
        );
    }
    ...
    public sealed class LightPatternStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.White, SKColors.LightGray,
            (start, end) =>
            {
    ...
    public sealed class FrostedGlassStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.White, SKColors.LightGray, CreateFrostedGlassPaint);
    ...
    public sealed class MetallicGradientStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            new SKColor(0x80, 0x80, 0x80), new SKColor(0xE0, 0xE0, 0xE0),
    ...
    public sealed class RainbowStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.Red, SKColors.Violet,
            (_, __) =>
            {
                var colors = new[] { SKColors.Red, SKColors.Orange, SKColors.Yellow, SKColors.Green, SKColors.Blue, SKColors.Indigo, SKColors.Violet };
                var paint = BasePaint();
    ...
    public sealed class ShadowedStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.Gray, SKColors.DarkGray,
            (start, end) =>
            {
                var paint = BasePaint();
    ...
    public sealed class TextureStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.LightBlue, SKColors.LightGreen,
            (start, end) =>
            {
                ...
                {
                    Shader = SKShader.CreateLinearGradient(new SKPoint(0, 0), new SKPoint(40, 40), new[] { SKColors.LightBlue, SKColors.LightGreen }, null, SKShaderTileMode.Clamp)
                };
                canvas.DrawRect(0, 0, 40, 40, grad);
                using var linePaint = new SKPaint { Color = SKColors.DarkBlue, StrokeWidth = 2 };
                for (int y = 5; y < 40; y += 10) canvas.DrawLine(0, y, 40, y, linePaint);
                var paint = BasePaint();
                paint.Shader = SKShader.CreateBitmap(bmp, SKShaderTileMode.Repeat, SKShaderTileMode.Repeat);
                return paint;
            }
    ...
    public sealed class SparkleStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.Gold, SKColors.Purple, CreateSparklePaint);
        private static SKPaint CreateSparklePaint(SKColor start, SKColor end)
        {
            var paint = BasePaint();
            paint.Shader = SKShader.CreateRadialGradient(new SKPoint(0.5f, 0.5f), 0.5f, new[] { start, end }, new[] { 0f, 1f }, SKShaderTileMode.Clamp);
    ...
    public sealed class SoftGradientStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.Teal, SKColors.OrangeRed, CreateSoftGradientPaint);
    ...
    public sealed class DarkNeonStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(
            SKColors.DeepSkyBlue, SKColors.DodgerBlue, CreateDarkNeonPaint);
    ...
    public sealed class VaporwaveStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(NeonPink, NeonBlue, CreateVaporwavePaint);
    ...
    public sealed class EmeraldGlowStyleCommand : BaseStyleCommand
    {
        ...
        public override StyleDefinition CreateStyle() => new(EmeraldStart, EmeraldEnd, CreateEmeraldGlowPaint);
